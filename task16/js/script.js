window.addEventListener('DOMContentLoaded', function () {
    'use strict';
    alert('Задание №16, скрипт подключен');
...
let persons = document.querySelectorAll('.counter-block-input')[0],
    ...
    totalValue.innerHTML = 0; //выставляем итоговые данные из верстки в ноль
    ...
    place.addEventListener('change', function() {  //выбор места
        if (restDays.value == '' || persons.value == '') {
            totalValue.innerHTML = 0;
        } else {
            let a = total; //избегаем накопления в тотал при смене локации
